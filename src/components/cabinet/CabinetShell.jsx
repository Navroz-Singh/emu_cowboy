export default function CabinetShell({ children }) {
  return (
    <div className="cabinet-lines relative h-dvh overflow-hidden px-2 py-2 md:px-3 md:py-3">
      ...
      <div className="relative mx-auto flex h-full min-h-0 w-full max-w-362.5 items-center justify-center">
        {children}
      </div>
    </div>
  );
