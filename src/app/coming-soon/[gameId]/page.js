  ...
  return (
    <main className="flex min-h-dvh items-center justify-center bg-(--cabinet-tan) p-4 text-(--foreground)">
      <div className="arcade-border w-full max-w-xl bg-(--cabinet-tan)/40 p-6 text-center">
        <h1 className="saloon-title text-3xl text-(--title-red) md:text-5xl">COMING SOON</h1>
        <p className="mt-4 text-sm md:text-base">{cartridge.title.toUpperCase()} IS STILL IN DEVELOPMENT.</p>
